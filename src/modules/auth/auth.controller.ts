...
export class AuthController {
  ...
  @ApiResponse({
    status: 201,
    description: 'User created, email verification pending',
    example: {
  ...
  @ApiResponse({
    ...
    example: { message: 'Password reset code sent to your email' },
  })
  ...
  @ApiResponse({
    ...
    example: { message: 'Code resent to your email' },
  })
  @Post('resend-code')
  ...
  @ApiResponse({
    ...
    example: { message: 'Reset code is valid', email: 'john@example.com' },
  })
  @Post('reset-code')
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Get authenticated profile (legacy compatibility payload)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 403,
    description: 'userId must match authenticated user',
  })
  ...
  @ApiResponse({
    ...
    example: {
      username: 'johndoe2',
      name: 'John Doe',
      image: 'https://cloudinary.com/.../newprofile.jpg',
      updated: true,
    },
  })
