...
export class CreateAuctionDto {
  ...
  @ApiProperty({
    example: 'Authentic 1970s brown leather jacket in excellent condition',
  ...
  @ApiProperty({
    example: 5000,
    description: 'Starting bid price in currency units',
  })
  @IsNumber()
  @Min(1)
  ...
  @ApiProperty({
    ...
    description: 'ISO 8601 auction start time',
  })
  @IsDateString()
  startTime!: string;
  ...
  @ApiProperty({
    ...
    description: 'ISO 8601 auction end time',
  })
  @IsDateString()
  endTime!: string;
