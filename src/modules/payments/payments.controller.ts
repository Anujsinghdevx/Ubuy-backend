...
export class PaymentsController {
  ...
  @ApiResponse({
    ...
    example: {
      linkId: 'link_abc123def456',
      shortUrl: 'https://cashfree.com/pay/abc123',
    },
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Payment link created for auction winner',
    example: {
      message: 'Payment link created successfully',
      linkId: 'auction_507f1f77bcf86cd799439011_1712345678901',
      linkUrl: 'https://payments.cashfree.com/links/abc123',
    },
  })
  @UseGuards(JwtAuthGuard)
  @Post('notify-payment')
  ...
  @ApiOperation({
    summary: 'Compatibility: check auction payment status by linkId',
  })
  @ApiResponse({
    status: 200,
